...
@WebFilter(urlPatterns = { "/admin/dashboard", "/admin/category", "/admin/article", "/admin/account", "/admin/account/update", "/admin/account/delete", "/admin/category/load", "/admin/category/update", "/admin/category/delete" })
